...
import { collected, roundMoney } from '../lib/accounting'
export default function ConsignmentModal({ order, onSave, onClose, showToast }) {
  ...
  const due = roundMoney(items.reduce((n, i) => n + Number(i.sold_qty || 0) * Number(i.unit_price), 0))
